...
> **`graph-powers:explorer` = the research agent shipped by the graph-powers plugin** — structured findings table with confidence scores (1-5), Knowledge Gaps, Librarian Requests.
